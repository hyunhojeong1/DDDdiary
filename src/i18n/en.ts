...
const en = {
  ...
  todayWScreen: {
    ...
    q1: "1. What do you need to do today?:",
    placeholderQ1: "e.g., Do laundry, meet a friend, go shopping, study",
    q2: "2. What would you like to do today?:",
    ...
    explainReuse: "Loads the most recently used past alarm.",
    comeHere: "Come forth",
  ...
  todayRScreen: {
    ...
    q1: "1. Today’s tasks:",
    q2: "2. Things you want to do today:",
  ...
  dailyQuestion: {
    generalQ: "Take a moment to reflect on your past memories and answer the question below.",
